<button type="button" onclick="myFunction2(); ttPosition();">Switch to Glagolitic</button>
<button type="button" onclick="myFunction1(); ttPosition();">Switch to Cyrillic</button>
<button type="button" onclick="myFunction3(); ttPosition();">Switch to Common Slavic</button>
<br>
...
<input type="checkbox" id="loan_place" name="loan_place" disabled="disabled">
  ...
  <input type="radio" id="undone" name="undone" onclick="undoFunction(); ttPosition();" style="display: none">
    ...
    <input type="radio" id="redone" name="undone" onclick="redoFunction(); ttPosition();" style="display: none">
